  ...
  return (
    <div className="max-w-md rounded-lg overflow-hidden shadow-lg bg-white border border-gray-200">
      <div className="flex">
        ...
        <div className="w-2/3 p-4">
          ...
          <p className="text-sm text-gray-700 mb-2">
            por <span className="font-medium">{nombreProveedor}</span>
          </p>

          {/* Calificación */}
          <div className="flex items-center mb-2">
            <div className="flex mr-1">{renderEstrellas(calificacion)}</div>
      ...
      <div className="px-4 py-3 bg-gray-50 border-t border-gray-200 flex justify-center">
        <button
          className="px-4 py-1 bg-[#162C51] border border-[#162C51] rounded-md text-sm font-medium text-white hover:bg-[#1d3867]"
